...
# so the root interval (fast speciation) is adjusted to be as long as necessary to get the right number of tips
interval <- 9

set.seed(0)
phy.all <- sim.rateshift.taxa(350, 50, c(0.1, 0.2, 0.3), c(0.05, 0.05, 0.05),
