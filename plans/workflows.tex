...
% NOTE: need to think through what a contributor would need to download from the database in order to develop/run stuff locally before uploading to real database
