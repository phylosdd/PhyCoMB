...
\newcommand{\Element}{\textit{TestElement}\xspace}
\newcommand{\Elements}{\textit{TestElement}s\xspace}
% todo: for the change to TestElement, need to read through the text to make additional changes (figures, lower case, a/an)
...
\newcommand{\Reports}{\textit{Reports}\xspace}
